...
public partial class WebshopHbCustomerRequest
{
    ...
    public virtual ICollection<WebshopHbCustomerRequestLine> WebshopHbCustomerRequestLines { get; } = new List<WebshopHbCustomerRequestLine>();
}
