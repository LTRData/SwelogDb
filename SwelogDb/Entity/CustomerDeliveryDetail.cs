...
public partial class CustomerDeliveryDetail
{
    ...
    public int? ComplaintRecNo { get; set; }

    public decimal? RecvdQtyPackmtrl { get; set; }

    public decimal? ApprovedQtyPackmtrl { get; set; }

    public string? FinalFlagPackmtrl { get; set; }
    ...
    public virtual CustomerDeliveryHeader DeliveryNoteNumberNavigation { get; set; } = null!;
}
