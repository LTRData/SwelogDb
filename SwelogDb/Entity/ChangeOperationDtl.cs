...
public partial class ChangeOperationDtl
{
    ...
    public virtual ChangeOperationListHdr? ChildOperationListNavigation { get; set; }

    public virtual ChangeOperationListHdr OperationListNavigation { get; set; } = null!;
